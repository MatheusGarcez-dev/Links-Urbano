...
export default function BorderGlow({
  ...
  return (
    ...
    >
          ...
          <span
            ...
            style={{
              ...
              maskImage:
                "conic-gradient(from " +
                angleDeg +
                " at center, black 2.5%, transparent 10%, transparent 90%, black 97.5%)",
              WebkitMaskImage:
                "conic-gradient(from " +
                angleDeg +
                " at center, black 2.5%, transparent 10%, transparent 90%, black 97.5%)",
      ...
      <div className="relative z-[1] flex h-full min-h-0 flex-col overflow-hidden rounded-[inherit] [&>*]:h-full [&>*]:min-h-0">
        {children}
      </div>
    </div>
  );
